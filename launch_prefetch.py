...
class ExperimentManager:
    ...
    def launch(self, l2_prefecther):
        ...
        outdir = '--outdir=' + WHERE_AM_I + "/results/" + self.args.bench_name + "/" + graph_name + "/prefetch_" + l2_prefecther
        ...
        other_script_options += ' --l2cache --l2_size=4kB --l2-hwp-type={}'.format(l2_prefecther)
        ...
        try:    
            print("\n\nStarted with l2_prefetcher: {} ".format(l2_prefecther))
